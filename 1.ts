...
//var url= "https://www.cnblogs.com/wonglu/archive/2015/12/04/5018351.html";
...
let promose = postMessage(url,postData,header);


var pp = function pluginName(tree) {
...
promose.then((html) => {
   ...
   posthtml([pp]).process(html).then((result)=>{
